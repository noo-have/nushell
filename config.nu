...
module pnpm {
  ...
  # 依据package.json文件安装依赖
  export extern "pnpm i" [
  ...
  # 设置node版本
  export extern "pnpm env use" [
    --global # 全局版本
    node版本
  ]

  # 删除node版本
  export extern "pnpm env remove" [
    --global # 全局版本
    node版本
  ]
}
...
let-env config = {
  ...
  show_banner: false # 控制是否显示标语(logo)
